...
layout: default
title: Fun Finds
description: Articles and posts I've found worth sharing
---
...
- [Effective AI Applications in Medicine](https://m.youtube.com/watch?v=rNDjdqzSdtY&time_continue=1&source_ve_path=NzY3NTg&embeds_referring_euri=https%3A%2F%2Fappliedaisummit.org%2F)  
[RAG in Healthcare Applications](https://youtu.be/gQUC0au1RSA)  
...
- [Linear Regression by Hand](https://www.byhand.ai/p/linear-regression-new-free-series)  
I started down the data science path later in life, so my understanding of linear algebra wasn't the best.  This workbook really improved my ability to visualize matrices.

- [Rag Techniques](https://app.readytensor.ai/publications/streamlining-employee-qa-using-retrievalaugmented-generation-rag-m2VlZTBnZVgT)  
